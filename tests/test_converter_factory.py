...
class TestConverterFactory:
    ...
    def test_get_converter_remote_mode(self, mock_factory_settings: Any, mock_remote_settings: Any, mock_client: Any) -> None:
    ...
    @patch("docling_mcp.tools.converters.remote.settings")
    @patch("docling_mcp.tools.converters.factory.settings")
    def test_get_converter_fallback_to_local(self, mock_factory_settings: Any, mock_remote_settings: Any, mock_client: Any) -> None:
        """Test factory falls back to local when remote fails and fallback enabled."""
        mock_factory_settings.conversion_mode = ConversionMode.REMOTE
        mock_factory_settings.fallback_to_local = True
        mock_remote_settings.service_url = None  # This will cause RemoteDocumentConverter to fail
    ...
    @patch("docling_mcp.tools.converters.remote.settings")
    @patch("docling_mcp.tools.converters.factory.settings")
    def test_get_converter_no_fallback_when_local_unavailable(self, mock_factory_settings: Any, mock_remote_settings: Any) -> None:
    ...
    @patch("docling_mcp.tools.converters.remote.settings")
    @patch("docling_mcp.tools.converters.factory.settings")
    def test_get_converter_remote_unavailable_no_fallback(self, mock_factory_settings: Any, mock_remote_settings: Any, mock_client: Any) -> None:
